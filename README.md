...
### Примечание:
В целом, это тестирование выявило баги не критические, но в конечном итоге
приводящие к неудобству для пользователя, особенно если пользователь не знаком с городом.
Также были найдены баги, которые могут разочаровать пользователя в использовании приложения. 
Однако тестирование выявило стабильность работы приложения при отсутствии 
сети и его корректное поведение в Google Play.
...
1. Окно приложения (входит в критическую зону)
2. Окно поиска (в зону стабильности)
3. Окно карточки маршрута (входит в зону стабильности)
